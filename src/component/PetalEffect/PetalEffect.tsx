...
export default function PetalEffect() {
  return (
    <div className={styles.petalContainer}>
      ...
      <div className={styles.petal} style={{ left: '22%', animationDuration: '23s' }}></div>
      ...
      <div className={styles.petal} style={{ left: '75%', animationDuration: '12s' }}></div>
      <div className={styles.petal} style={{ left: '90%', animationDuration: '15s' }}></div>
    </div>
  );
}